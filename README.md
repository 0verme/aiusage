<p align="center"><strong>AIUsage 0verme Fork v1.1.0</strong></p>
...
```text
Clone https://github.com/0verme/aiusage.git, read skills/aiusage-server/aiusage-server.md,
...
```bash
git clone https://github.com/0verme/aiusage.git
...
The npm registry publication for v1.1.0 is pending. For a source or NAS/vendor
...
`npm install -g @0verme/aiusage-cli@1.1.0` rather than `@latest`.
