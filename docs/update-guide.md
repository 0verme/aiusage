...
- **CLI version mismatch** — Run `aiusage --version` and compare with the published pinned release on [npm](https://www.npmjs.com/package/@0verme/aiusage-cli). Rebuild/vendor install while registry publication is pending.
