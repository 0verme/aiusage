...
function semanticSnapshot(hostname) {
  return buildSemanticSnapshot({
    ...
    daily_usage: {
      ...
      rows: [{ device_id: 'device-a', usage_date: '2026-08-27', event_count: 1 }],
    },
    daily_usage_breakdown: {
      keyFields: ['device_id', 'usage_date', 'provider', 'product', 'channel', 'model', 'project'],
      rows: [],
    },
    daily_activity_breakdown: {
      keyFields: ['device_id', 'usage_date', 'provider', 'product', 'source', 'project', 'kind', 'name', 'confidence'],
      rows: [],
    },
    schema: {
