      ...
      const sections = [
        {
          ...
          centerLabel: formatUsd(overview?.totalCostUsd ?? 0, currency),
          formatValue: (value: number) => formatUsd(value, currency),
          formatTooltipValue: (value: number) => formatUsdFull(value, currency),
        },
        {
