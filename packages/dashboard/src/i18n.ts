...
export const I18N = {
  en: {
    ...
    sessions: 'Sessions', userMessages: 'User Messages',
    ...
    interactionMetrics: 'Interaction Metrics', exactEvents: 'Exact Events', costPerSession: 'Cost / Session',
    proxySignals: 'Proxy Signals', functionCalls: 'Function Calls',
    toolCalls: 'Tool Calls', skillCalls: 'Skill Calls',
    subagents: 'Subagents', topTools: 'Top Tools',
    topSkills: 'Top Skills', topSubagents: 'Top Subagents',
    proxy: 'proxy',
    ...
    device: 'Device', tool: 'Tool', product: 'Product', model: 'Model', mergeModelAliases: 'Merge model aliases', rawModelAliases: 'Raw model aliases', aliasCount: 'aliases', all: 'All',
  ...
  zh: {
    ...
    sessions: '会话数', userMessages: '用户对话数',
    avgDailyCost: '日均费用', cacheHitRate: '缓存命中率',
    costTrend: '费用趋势', tokenTrend: 'Token 趋势',
    tokenComposition: 'Token 构成', tokenFlow: 'Token 流向',
    interactionMetrics: '交互指标', exactEvents: '确切事件', costPerSession: '单会话费用',
    proxySignals: '代理信号', functionCalls: 'Function Call',
    toolCalls: '工具调用', skillCalls: 'Skill 调用',
    subagents: 'Subagent', topTools: '高频工具',
    topSkills: '高频 Skill', topSubagents: '高频 Subagent',
    proxy: '代理',
    providerShare: '厂商占比', modelShare: '模型占比',
    channelShare: '渠道占比', deviceShare: '设备占比', thisMonth: '本月',
    device: '设备', tool: '工具', product: '产品', model: '模型', mergeModelAliases: '合并模型别名', rawModelAliases: '原始模型别名', aliasCount: '个别名', all: '全部',
