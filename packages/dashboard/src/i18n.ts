...
export const I18N = {
  en: {
    ...
    interactionMetrics: 'Interaction Metrics', exactEvents: 'Exact Events',
    ...
    autoResizeDesc: 'Embed widgets automatically report height changes via postMessage. Add this script to let iframes auto-fit content.',
  ...
  zh: {
    ...
    interactionMetrics: '交互指标', exactEvents: '确切事件',
    ...
    autoResizeDesc: '嵌入组件会通过 postMessage 自动报告高度变化。添加以下脚本即可让 iframe 自动适配内容高度。',
