...
```text
克隆 https://github.com/0verme/aiusage.git，阅读 skills/aiusage-server/aiusage-server.md，
...
本次 v1.1.0 尚未完成 npm registry 发布。当前可从源码构建，用于 NAS 或其他
vendor 安装：
...
例如 `npm install -g @0verme/aiusage-cli@1.1.0`，不要默认使用 `@latest`。
